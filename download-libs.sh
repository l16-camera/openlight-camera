...
dl_aar  "support-compat.jar"             "$BASE/support-compat/26.1.0/support-compat-26.1.0.aar"
dl_aar  "support-core-ui.jar"            "$BASE/support-core-ui/26.1.0/support-core-ui-26.1.0.aar"
dl_aar  "support-core-utils.jar"         "$BASE/support-core-utils/26.1.0/support-core-utils-26.1.0.aar"
dl_aar  "support-fragment.jar"           "$BASE/support-fragment/26.1.0/support-fragment-26.1.0.aar"
dl_aar  "support-media-compat.jar"       "$BASE/support-media-compat/26.1.0/support-media-compat-26.1.0.aar"
...
ARCH="https://dl.google.com/dl/android/maven2/android/arch"
dl_jar  "arch-core-common.jar"           "$ARCH/core/common/1.0.0/common-1.0.0.jar"
dl_jar  "arch-lifecycle-common.jar"      "$ARCH/lifecycle/common/1.0.0/common-1.0.0.jar"
dl_aar  "arch-lifecycle-runtime.jar"     "$ARCH/lifecycle/runtime/1.0.3/runtime-1.0.3.aar"
